...
const AboutPage = () => {
  const skills = [
    ...
    { category: 'Web Development', items: ['React', 'Node.js', 'D3.js', 'HTML/CSS', 'REST APIs'] },
    { category: 'Tools', items: ['Jupyter', 'Git', 'Docker', 'Tableau', 'AWS/GCP'] }
  ];
  ...
  const education = [
    ...
    },
    {
      ...
      year: '2016-2020',
      description: 'Specialized in software engineering and database systems with a minor in Mathematics.'
    }
  ];
